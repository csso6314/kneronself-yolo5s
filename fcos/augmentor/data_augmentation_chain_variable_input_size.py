...
from augmentor.object_detection_2d_photometric_ops import ConvertColor, ConvertDataType, ConvertTo3Channels, RandomBrightness, RandomContrast, RandomHue, RandomSaturation
from augmentor.object_detection_2d_geometric_ops import Resize, RandomFlip
from augmentor.object_detection_2d_patch_sampling_ops import PatchCoordinateGenerator, RandomPatch
from augmentor.object_detection_2d_image_boxes_validation_utils import BoxFilter, ImageValidator
...
class DataAugmentationVariableInputSize:
    ...
    def __init__(self,
        ...
        self.random_patch          = RandomPatch(patch_coord_generator=self.patch_coord_generator,
                                                 ...
                                                 can_fail=False,
                                                 labels_format=self.labels_format)
        self.random_gray = ConvertColor(current='RGB', to='GRAY',prob=0.5)
